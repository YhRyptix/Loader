...
loadingWindow.Size = UDim2.fromScale(0.32, 0.28)
...
local topLabels = Instance.new("Frame")
    ...
    topLabels.BorderColor3 = Color3.fromRGB(0, 0, 0)
    topLabels.BorderSizePixel = 0
    topLabels.Position = UDim2.fromScale(0, 0.02)
    topLabels.Size = UDim2.fromScale(1, 0.22) -- relative to loadingWindow
...
local textLabel = Instance.new("TextLabel")
    ...
    textLabel.Size = UDim2.fromScale(0.60, 1)
...
local close = Instance.new("ImageLabel")
    ...
    close.BackgroundColor3 = Color3.fromRGB(74, 74, 75)
    close.BackgroundTransparency = 1
    close.Position = UDim2.fromScale(0.845, 0.22)
    close.Size = UDim2.fromScale(0.06, 0.8)
...
local purpleLine = Instance.new("Frame")
    ...
    purpleLine.BorderColor3 = Color3.fromRGB(0, 0, 0)
    purpleLine.BorderSizePixel = 0
    purpleLine.Position = UDim2.fromScale(0, 0.92)
    purpleLine.Size = UDim2.fromScale(1, 0.04)
purpleLine.Parent = topLabels
...
local backgroundLoadBar = Instance.new("Frame")
    ...
    backgroundLoadBar.Position = UDim2.fromScale(0.12, 0.20)
    backgroundLoadBar.Size = UDim2.fromScale(0.76, 0.10)
...
local loadingLine = Instance.new("Frame")
    ...
    loadingLine.Size = UDim2.fromScale(0.08, 1)
...
local kapaLogo = Instance.new("ImageLabel")
    ...
    kapaLogo.Position = UDim2.fromScale(0.5, 0.62)
    kapaLogo.Size = UDim2.fromScale(0.48, 0.46)
